...
FwStandardModelsFwQueryResponseWebApiModulesWarehouseActivityActivityLogic
    _$FwStandardModelsFwQueryResponseWebApiModulesWarehouseActivityActivityLogicFromJson(
        ...
        FwStandardModelsFwQueryResponseWebApiModulesWarehouseActivityActivityLogic(
          items: (json['Items'] as List<dynamic>?)
                  ?.map((e) => WebApiModulesWarehouseActivityActivity.fromJson(
                      e as Map<String, dynamic>))
                  .toList() ??
              [],
          pageNo: (json['PageNo'] as num?)?.toInt(),
    ...
    _$MicrosoftAspNetCoreMvcActionResultWebApiModulesWarehouseActivityActivityLogicFromJson(
        ...
        MicrosoftAspNetCoreMvcActionResultWebApiModulesWarehouseActivityActivityLogic(
          ...
          $Value: json['Value'] == null
              ? null
              : WebApiModulesWarehouseActivityActivity.fromJson(
    ...
    _$WebApiModulesWarehouseActivityActivityFromJson(
        ...
        WebApiModulesWarehouseActivityActivity(
          ...
          activityStatusDescription:
              json['ActivityStatusDescription'] as String?,
          ...
          forcedComplete: json['ForcedComplete'] as bool?,
          dateStamp: json['DateStamp'] as String?,
          auditNote: json['AuditNote'] as String?,
          recordTitle: json['RecordTitle'] as String?,
          urlIdentifier: json['UrlIdentifier'],
...
Map<String, dynamic> _$WebApiModulesWarehouseActivityActivityToJson(
        WebApiModulesWarehouseActivityActivity instance) =>
    <String, dynamic>{
      ...
      if (instance.activityStatusDescription case final value?)
      ...
      if (instance.activityDateTime?.toIso8601String() case final value?)
      ...
      if (instance.forcedComplete case final value?) 'ForcedComplete': value,
      if (instance.dateStamp case final value?) 'DateStamp': value,
      if (instance.auditNote case final value?) 'AuditNote': value,
      if (instance.recordTitle case final value?) 'RecordTitle': value,
      if (instance.urlIdentifier case final value?) 'UrlIdentifier': value,
