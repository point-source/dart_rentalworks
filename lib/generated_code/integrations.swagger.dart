...
import 'integrations.metadata.swagger.dart';
...
abstract class Integrations extends ChopperService {
  ...
  ///Update storefront settings.
  @PUT(path: '/storefront/settings', optionalBody: true)
...
(When a product is removed from a catalog the catalog\'s product id will change, so we can query this endpoint to update the product ids in a users shopping cart if we can find the same InventoryId on a different catalog listing.''',
  ...
  ///@param filter
  Future<
    chopper.Response<WebApiModulesIntegrationsStorefrontStorefrontProductL>
  >
  storefrontProductProductidWarehouseidWarehouseidLocationidLocationidFromdateFromdateTodateTodateGet({
    ...
    generatedMapping.putIfAbsent(
      ...
      () =>
          WebApiModulesIntegrationsStorefrontStorefrontProductL.fromJsonFactory,
    );
  ...
  ///Login (for Contacts)
  @POST(path: '/storefront/login', optionalBody: true)
  Future<chopper.Response<WebApiModulesIntegrationsStorefrontLoginResponse>>
  _storefrontLoginPost({
    @Body() required WebApiModulesIntegrationsStorefrontLoginRequest? body,
    @chopper.Tag()
    SwaggerMetaData swaggerMetaData = const SwaggerMetaData(
      description: '',
  ...
  ///Login (for Contacts)
  @POST(path: '/storefront/login/azure', optionalBody: true)
  Future<chopper.Response<WebApiModulesIntegrationsStorefrontLoginResponse>>
  ...
  ///Send email to Reset Password (for Contacts)
  @POST(path: '/storefront/sendresetpasswordemail', optionalBody: true)
  ...
  ///Send email to Reset Password (for Contacts)
  @POST(path: '/storefront/resetpasswordfromemail', optionalBody: true)
  Future<chopper.Response<WebApiModulesIntegrationsStorefrontLoginResponse>>
  ...
  ///Register a new account (Contact)
  @POST(path: '/storefront/register', optionalBody: true)
  Future<
    chopper.Response<
      WebApiModulesIntegrationsStorefrontContactRegistrationResponse
    >
  ...
  ///@param todate
  Future<
    chopper.Response<WebApiModulesIntegrationsStorefrontProductAvailability>
  >
  ...
  ///Submit a Quote Request
  @POST(path: '/storefront/submitquoterequest', optionalBody: true)
  Future<
    chopper.Response<
      WebApiModulesIntegrationsStorefrontSubmitQuoteRequestResponse
    >
  ...
  _storefrontSubmitquoterequestPost({
    @Body() required WebApiModulesIntegrationsStorefrontQuoteRequest? body,
    @chopper.Tag()
    SwaggerMetaData swaggerMetaData = const SwaggerMetaData(
      description: '',
  ...
  ///Send an inquiry email about an item.
  @POST(path: '/storefront/sendinquiryemail', optionalBody: true)
  Future<
    chopper.Response<
      WebApiModulesIntegrationsStorefrontSendInquiryEmailResponse
    >
  ...
  ///@param id
  Future<
    chopper.Response<WebApiModulesIntegrationsStorefrontStorefrontProgress>
  >
  storefrontProgressmeterIdGet({required String? id}) {
    generatedMapping.putIfAbsent(
      WebApiModulesIntegrationsStorefrontStorefrontProgress,
      () =>
          WebApiModulesIntegrationsStorefrontStorefrontProgress.fromJsonFactory,
    );
...
class FwStandardModelsFwQueryResponseWebApiModulesIntegrationsStorefrontStorefrontProductLoader {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other
                is FwStandardModelsFwQueryResponseWebApiModulesIntegrationsStorefrontStorefrontProductLoader &&
            (identical(other.items, items) ||
                const DeepCollectionEquality().equals(other.items, items)) &&
            (identical(other.pageNo, pageNo) ||
                const DeepCollectionEquality().equals(other.pageNo, pageNo)) &&
...
extension $FwStandardModelsFwQueryResponseWebApiModulesIntegrationsStorefrontStorefrontProductLoaderExtension
  ...
  FwStandardModelsFwQueryResponseWebApiModulesIntegrationsStorefrontStorefrontProductLoader
  copyWithWrapped({
    Wrapped<List<WebApiModulesIntegrationsStorefrontStorefrontProductL>?>?
    items,
    Wrapped<int?>? pageNo,
    Wrapped<int?>? pageSize,
    Wrapped<int?>? totalItems,
...
class ShopifySharpEntitiesReturn {
  const ShopifySharpEntitiesReturn({this.id, this.adminGraphqlApiId});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is ShopifySharpLineItem &&
            ...
            (identical(other.preTaxPrice, preTaxPrice) ||
                const DeepCollectionEquality().equals(
                  other.preTaxPrice,
                  preTaxPrice,
                )) &&
            (identical(other.preTaxPriceSet, preTaxPriceSet) ||
                const DeepCollectionEquality().equals(
                  other.preTaxPriceSet,
                  preTaxPriceSet,
                )) &&
            (identical(other.duties, duties) ||
                const DeepCollectionEquality().equals(other.duties, duties)) &&
            (identical(other.fulfillmentLineItemId, fulfillmentLineItemId) ||
                const DeepCollectionEquality().equals(
                  other.fulfillmentLineItemId,
                  fulfillmentLineItemId,
                )) &&
            (identical(other.attributedStaffs, attributedStaffs) ||
                const DeepCollectionEquality().equals(
                  other.attributedStaffs,
                  attributedStaffs,
                )) &&
            (identical(other.id, id) ||
                const DeepCollectionEquality().equals(other.id, id)) &&
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is ShopifySharpOrder &&
            ...
            (identical(other.note, note) ||
                const DeepCollectionEquality().equals(other.note, note)) &&
            (identical(other.noteAttributes, noteAttributes) ||
                const DeepCollectionEquality().equals(
                  other.noteAttributes,
                  noteAttributes,
                )) &&
            ...
            (identical(other.orderStatusUrl, orderStatusUrl) ||
                const DeepCollectionEquality().equals(
                  other.orderStatusUrl,
                  orderStatusUrl,
                )) &&
            (identical(other.paymentGatewayNames, paymentGatewayNames) ||
                const DeepCollectionEquality().equals(
                  other.paymentGatewayNames,
                  paymentGatewayNames,
                )) &&
            ...
            (identical(other.shippingLines, shippingLines) ||
                const DeepCollectionEquality().equals(
                  other.shippingLines,
                  shippingLines,
                )) &&
            ...
            (identical(other.totalTipReceived, totalTipReceived) ||
                const DeepCollectionEquality().equals(
                  other.totalTipReceived,
                  totalTipReceived,
                )) &&
            ...
            (identical(other.currentTotalDutiesSet, currentTotalDutiesSet) ||
                const DeepCollectionEquality().equals(
                  other.currentTotalDutiesSet,
                  currentTotalDutiesSet,
                )) &&
            (identical(other.originalTotalDutiesSet, originalTotalDutiesSet) ||
                const DeepCollectionEquality().equals(
                  other.originalTotalDutiesSet,
                  originalTotalDutiesSet,
                )) &&
            (identical(other.presentmentCurrency, presentmentCurrency) ||
                const DeepCollectionEquality().equals(
                  other.presentmentCurrency,
                  presentmentCurrency,
                )) &&
            (identical(other.totalLineItemsPriceSet, totalLineItemsPriceSet) ||
                const DeepCollectionEquality().equals(
                  other.totalLineItemsPriceSet,
                  totalLineItemsPriceSet,
                )) &&
            (identical(other.totalDiscountsSet, totalDiscountsSet) ||
                const DeepCollectionEquality().equals(
                  other.totalDiscountsSet,
                  totalDiscountsSet,
                )) &&
            (identical(other.totalShippingPriceSet, totalShippingPriceSet) ||
                const DeepCollectionEquality().equals(
                  other.totalShippingPriceSet,
                  totalShippingPriceSet,
                )) &&
            (identical(other.subtotalPriceSet, subtotalPriceSet) ||
                const DeepCollectionEquality().equals(
                  other.subtotalPriceSet,
                  subtotalPriceSet,
                )) &&
            ...
            (identical(other.estimatedTaxes, estimatedTaxes) ||
                const DeepCollectionEquality().equals(
                  other.estimatedTaxes,
                  estimatedTaxes,
                )) &&
            (identical(other.currentSubtotalPrice, currentSubtotalPrice) ||
                const DeepCollectionEquality().equals(
                  other.currentSubtotalPrice,
                  currentSubtotalPrice,
                )) &&
            (identical(
                  other.currentSubtotalPriceSet,
            ...
            (identical(other.currentTotalDiscounts, currentTotalDiscounts) ||
                const DeepCollectionEquality().equals(
                  other.currentTotalDiscounts,
                  currentTotalDiscounts,
                )) &&
            (identical(
                  other.currentTotalDiscountsSet,
            ...
            (identical(
                  other.originalTotalAdditionalFeesSet,
...
class ShopifySharpOrderCompany {
  const ShopifySharpOrderCompany({this.id, this.locationId});
...
class ShopifySharpRefundDutyType {
  const ShopifySharpRefundDutyType({this.dutyId, this.refundType});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is ShopifySharpTransaction &&
            ...
            (identical(
                  other.paymentsRefundAttributes,
    ...
    return identical(this, other) ||
        (other is StorefrontPackageItem &&
            ...
            (identical(other.defaultQuantity, defaultQuantity) ||
                const DeepCollectionEquality().equals(
                  other.defaultQuantity,
                  defaultQuantity,
                )) &&
            (identical(other.defaultQuantityColor, defaultQuantityColor) ||
                const DeepCollectionEquality().equals(
                  other.defaultQuantityColor,
                  defaultQuantityColor,
                )) &&
            ...
            (identical(other.isNestedComplete, isNestedComplete) ||
                const DeepCollectionEquality().equals(
                  other.isNestedComplete,
                  isNestedComplete,
                )) &&
            ...
            (identical(other.packageItemClass, packageItemClass) ||
                const DeepCollectionEquality().equals(
                  other.packageItemClass,
                  packageItemClass,
                )) &&
            (identical(other.itemNonDiscountable, itemNonDiscountable) ||
                const DeepCollectionEquality().equals(
                  other.itemNonDiscountable,
                  itemNonDiscountable,
                )) &&
            (identical(other.primaryInventoryId, primaryInventoryId) ||
                const DeepCollectionEquality().equals(
                  other.primaryInventoryId,
                  primaryInventoryId,
                )) &&
            ...
            (identical(other.dailyExtended, dailyExtended) ||
                const DeepCollectionEquality().equals(
                  other.dailyExtended,
                  dailyExtended,
                )) &&
            (identical(other.weeklyExtended, weeklyExtended) ||
                const DeepCollectionEquality().equals(
                  other.weeklyExtended,
                  weeklyExtended,
                )) &&
            (identical(other.monthlyExtended, monthlyExtended) ||
                const DeepCollectionEquality().equals(
                  other.monthlyExtended,
                  monthlyExtended,
                )) &&
...
class WebApiModulesIntegrationsStorefrontGetProductWarehouseDetailsResponse {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other
                is WebApiModulesIntegrationsStorefrontGetProductWarehouseDetailsResponse &&
            (identical(other.availability, availability) ||
                const DeepCollectionEquality().equals(
                  other.availability,
                  availability,
...
extension $WebApiModulesIntegrationsStorefrontProductCategoryExtension
  ...
  WebApiModulesIntegrationsStorefrontProductCategory copyWith({
    ...
    String? urlName,
    String? linkUrl,
    List<WebApiModulesIntegrationsStorefrontProductSubCategory>? subCategories,
  }) {
...
class WebApiModulesIntegrationsStorefrontProductImage {
  const WebApiModulesIntegrationsStorefrontProductImage({this.id, this.url});
...
class WebApiModulesIntegrationsStorefrontResetPasswordFromEmailRequest {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other
                is WebApiModulesIntegrationsStorefrontResetPasswordFromEmailRequest &&
            (identical(other.email, email) ||
                const DeepCollectionEquality().equals(other.email, email)) &&
            (identical(other.temporaryPassword, temporaryPassword) ||
                const DeepCollectionEquality().equals(
                  other.temporaryPassword,
                  temporaryPassword,
                )) &&
...
class WebApiModulesIntegrationsStorefrontSendResetPasswordEmailRequest {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other
                is WebApiModulesIntegrationsStorefrontSendResetPasswordEmailRequest &&
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is WebApiModulesIntegrationsStorefrontStorefrontProductL &&
            ...
            (identical(other.warehouseSpecific, warehouseSpecific) ||
                const DeepCollectionEquality().equals(
                  other.warehouseSpecific,
                  warehouseSpecific,
                )) &&
            ...
            (identical(other.shipWeightLbs, shipWeightLbs) ||
                const DeepCollectionEquality().equals(
                  other.shipWeightLbs,
                  shipWeightLbs,
                )) &&
            (identical(other.shipWeightOz, shipWeightOz) ||
                const DeepCollectionEquality().equals(
                  other.shipWeightOz,
                  shipWeightOz,
                )) &&
            ...
            (identical(other.webCatalog, webCatalog) ||
                const DeepCollectionEquality().equals(
                  other.webCatalog,
                  webCatalog,
                )) &&
            (identical(other.webCatalogUrlName, webCatalogUrlName) ||
                const DeepCollectionEquality().equals(
                  other.webCatalogUrlName,
                  webCatalogUrlName,
                )) &&
            ...
            (identical(other.inventoryDepartment, inventoryDepartment) ||
                const DeepCollectionEquality().equals(
                  other.inventoryDepartment,
                  inventoryDepartment,
                )) &&
            (identical(
                  other.inventoryDepartmentUrlName,
            ...
            (identical(other.categoryUrlName, categoryUrlName) ||
                const DeepCollectionEquality().equals(
                  other.categoryUrlName,
                  categoryUrlName,
                )) &&
            ...
            (identical(other.subCategoryUrlName, subCategoryUrlName) ||
                const DeepCollectionEquality().equals(
                  other.subCategoryUrlName,
                  subCategoryUrlName,
                )) &&
            (identical(other.original, original) ||
                const DeepCollectionEquality().equals(
...
extension $WebApiModulesIntegrationsStorefrontStorefrontProgressExtension
  ...
  WebApiModulesIntegrationsStorefrontStorefrontProgress copyWithWrapped({
    ...
    return WebApiModulesIntegrationsStorefrontStorefrontProgress(
      ...
      currentStep: (currentStep != null ? currentStep.value : this.currentStep),
...
class WebApiModulesIntegrationsStorefrontSubmitQuoteRequestResponse {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other
                is WebApiModulesIntegrationsStorefrontSubmitQuoteRequestResponse &&
            (identical(other.success, success) ||
                const DeepCollectionEquality().equals(
                  other.success,
                  success,
