...
abstract class Warehouse extends ChopperService {
  ...
  ///
  @POST(path: '/activity/browse', optionalBody: true)
  Future<chopper.Response<FwStandardSqlServerFwJsonDataTable>>
  _activityBrowsePost({
  ...
  Future<
    ...
    >
  >
  activityExportexcelxlsxPost({required FwStandardModelsBrowseRequest? body}) {
    generatedMapping.putIfAbsent(
      FwCoreControllersFwDataControllerDoExportExcelXlsxExportFileAsyncResult,
      () =>
          FwCoreControllersFwDataControllerDoExportExcelXlsxExportFileAsyncResult
  ...
  ///
  @POST(path: '/activity/exportexcelxlsx', optionalBody: true)
  Future<
    chopper.Response<
      FwCoreControllersFwDataControllerDoExportExcelXlsxExportFileAsyncResult
    >
  ...
  activityPost({required WebApiModulesWarehouseActivityActivity? body}) {
    generatedMapping.putIfAbsent(
  ...
  ///
  @POST(path: '/activity', optionalBody: true)
  Future<chopper.Response<WebApiModulesWarehouseActivityActivity>>
  _activityPost({
  ...
  ///
  ///@param id
  @PUT(path: '/activity/{id}', optionalBody: true)
  Future<chopper.Response<WebApiModulesWarehouseActivityActivity>>
  _activityIdPut({
    @Path('id') required String? id,
    @Body() required WebApiModulesWarehouseActivityActivity? body,
  ...
  ///
  @POST(path: '/activity/many', optionalBody: true)
  Future<
    chopper.Response<
      List<
        MicrosoftAspNetCoreMvcActionResultWebApiModulesWarehouseActivityActivityLogic
  ...
  >
  _activityManyPost({
    @Body() required List<WebApiModulesWarehouseActivityActivity>? body,
    @chopper.Tag()
    SwaggerMetaData swaggerMetaData = const SwaggerMetaData(
      description: '',
      summary: '',
  ...
  ///
  @POST(path: '/activity/validateactivitystatus/browse', optionalBody: true)
  Future<chopper.Response<FwStandardSqlServerFwJsonDataTable>>
  ...
  ///
  @POST(path: '/activity/validateuser/browse', optionalBody: true)
  Future<chopper.Response<FwStandardSqlServerFwJsonDataTable>>
  ...
  ///
  @POST(path: '/activity/validateactivitytype/browse', optionalBody: true)
  Future<chopper.Response<FwStandardSqlServerFwJsonDataTable>>
    ...
    return identical(this, other) ||
        (other is WebApiModulesWarehouseActivityActivity &&
            ...
            (identical(other.activityStatusColor, activityStatusColor) ||
                const DeepCollectionEquality().equals(
                  other.activityStatusColor,
                  activityStatusColor,
                )) &&
            (identical(
                  other.activityStatusTextColor,
            ...
            (identical(other.orderTypeDescription, orderTypeDescription) ||
                const DeepCollectionEquality().equals(
                  other.orderTypeDescription,
            ...
            (identical(other.completeQuantity, completeQuantity) ||
                const DeepCollectionEquality().equals(
                  other.completeQuantity,
                  completeQuantity,
                )) &&
            ...
            (identical(other.completePercent, completePercent) ||
                const DeepCollectionEquality().equals(
                  other.completePercent,
                  completePercent,
                )) &&
            (identical(other.forcedComplete, forcedComplete) ||
                const DeepCollectionEquality().equals(
                  other.forcedComplete,
                  forcedComplete,
                )) &&
            (identical(other.dateStamp, dateStamp) ||
                const DeepCollectionEquality().equals(
